...
cd $DIR/build
git fetch https://github.com/VigorCM/android_build linaro-4.8 && git cherry-pick 08de661ab5d510eed68efe5cfc2233b2774a100c && git cherry-pick https://github.com/VigorCM/android_build/commit/579ca658d8e807848f92c41a601e24d8ec918d4c
